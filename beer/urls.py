...
urlpatterns = [
    ...
    url(r'^v1/breweries/(?P<brewery>[0-9a-zA-Z-]+)/beers$', views.BreweryBeerList.as_view(), name='brewery-beer-list'),
    url(r'^v1/breweries/(?P<brewery>[0-9a-zA-Z-]+)/glasswares$', views.BreweryGlasswareList.as_view(), name='brewery-glassware-list'),
    ...
    url(r'^v1/locations/(?P<location>[0-9a-zA-Z-]+)/beers$', views.LocationBeerList.as_view(), name='location-beer-list'),
